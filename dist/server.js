...
router.get("/players", (req, res) => {
  ...
  if (playerType) {
    const players =
      (_a = data.bootstrap) === null || _a === void 0
        ? void 0
        : _a.elements
            ...
            .map((el) => {
              ...
              return {
                ...
                basic: el,
                summary:
                  (_a = data.summaries) === null || _a === void 0
                    ? void 0
                    : _a.find((sum) => sum.id === Number(playerType)),
              };
            });
  ...
  if (playerId) {
    ...
    player.basic =
      (_b = data.bootstrap) === null || _b === void 0
        ? void 0
        : _b.elements.find((el) => el.id === Number(playerId));
    player.summary =
      (_c = data.summaries) === null || _c === void 0
        ? void 0
        : _c.find((sum) => sum.id === Number(playerId));
    if (player.id) {
      res.status(200).send({ playerType, player });
    }
  }
  const players =
    (_d = data.bootstrap) === null || _d === void 0
      ? void 0
      : _d.elements.map((el) => {
          var _a;
          return {
...
router.get("/poll", (req, res) => {
  ...
  res.status(200).send({
    ...
    hasSummaries: !!((_a = data.summaries) === null || _a === void 0
      ? void 0
      : _a.length),
  });
});
